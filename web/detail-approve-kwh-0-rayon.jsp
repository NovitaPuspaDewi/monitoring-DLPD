...
<html>
    <%
        ...
        String nama = null, alamat = null, tarif = null, koordinat = null, tgl_upload = null,
                verifikasi = null, petugas_upload = null, petugas_approve = null, tgl_app = null;
        int daya = 0, kwh_maks = 0, totkwh = 0;

        List<Approve> kendaraanList = Approve.getDetailApprove_0(blth, idpel);
        for (int i = 0; i < kendaraanList.size(); i++) {
            ...
            petugas_approve = kendaraanList.get(i).getmPetugas_Approve();
        ...
        if (request.getParameter("foto") != null) {
            session.setAttribute("link1", "detail-approve-kwh-0-rayon.jsp");
                            ...
                            <div class="field">
                                <div class="field">
                                    <label>Petugas Approve
                                        <input name="petugas_approve" type="text" value="<%=petugas_approve%>" disabled="disabled"></label>
                                </div>
                            </div>
                        </div>
                        <div class="two fields">
