...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekApprove_blth_kwh0(pBlth);
        int count = Approve.hitungApprove_sudahcek_0(pBlth);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-sudah-approve-kwh-0-cek-bulan.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-sudah-approve-kwh-0-cek-bulan.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan dengan pemakaian listrik 0 kwh yang sudah di-Approve.<br>
