...
<html>
    <%
        ...
        int count = LihatData_Rayon.hitungKwh0_sudahcek(kode);
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh0-sudah-cek-rayon_1.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh 0 yang sudah dimonitoring UNITUP ${username} <br><br>
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 SUDAH CEK UNITUP ${username}
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<LihatData_Rayon> kendaraanList = LihatData_Rayon.getDataList_kwh0_sudah_cek(kode);
