...
<html>
    <%
        ...
        if (request.getParameter("commit") != null) {
            ...
            out.print("window.location = 'kwh0-belum-cek.jsp';");
            out.print("</script>");
                    ...
                    <div class="ui fluid form segment">
                        ...
                        <div class="two fields">
                            <div class="field">
                                ...
                                <input placeholder="Koordinat lokasi" value="<%=koordinat%>" name="koordinat" type="text">
                            </div>
                            <div class="field">
                                <label>Verifikasi</label>
                                <input placeholder="Masukan verifikasi hasil monitoring" value="<%=verifikasi%>"name="verifikasi" type="text">
                            </div>
                        </div>
                        <div class="two fields">
                            <div class="field">
                ...
                $("#saveMember").form({
                    ...
                    password: {
                        ...
                        rules: [
                            {
                                type: 'empty',
                                prompt: 'Masukkan tanggal monitoring'
                            }
                        ]
                    }
