...
<html>
    <%
        int count = LihatData.hitungKwhmaks_sudahcek();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh-maks-sudah-cek_1.jsp");
        ...
        if (request.getParameter("cari2") != null) {
            ...
            response.sendRedirect("data-kwh-maks-sudah-cek-cari-unitup_1.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh Maks yang sudah dimonitoring<br><br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS SUDAH CEK
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<LihatData> kendaraanList = LihatData.getDataList_kwhmaks_sudah_cek();
