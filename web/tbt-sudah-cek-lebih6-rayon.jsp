...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_lebih6_sudah_cek(kode);
        int count = kendaraanList.size();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "tbt-sudah-cek-lebih6-rayon.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan TBT lebih dari 6 bulan yang sudah dimonitoring UNITUP ${username}<br><br>
