...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_belum_approve(blth_sess);
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("tbt-detail-approve-blth.jsp");
        }
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
