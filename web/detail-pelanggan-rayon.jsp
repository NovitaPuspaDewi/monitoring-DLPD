    ...
    <%
        ...
        if (null != request.getParameter("cari")) {
         ...
         if (request.getParameter("kwh0-approve") != null) {
            String link = "detail-pelanggan-rayon.jsp";
        ...
        if (request.getParameter("kwh0-belum") != null) {
         ...
         if (request.getParameter("kwh0-beres") != null) {
            String link = "detail-pelanggan-rayon.jsp";
            session.setAttribute("link", link);
            session.setAttribute("id_blth", request.getParameter("kwh0-beres"));
        ...
        if (request.getParameter("kwhmaks-belum") != null) {
         ...
         if (request.getParameter("kwhmaks-beres") != null) {
            String link = "detail-pelanggan-rayon.jsp";
            session.setAttribute("link", link);
            session.setAttribute("id_blth", request.getParameter("kwhmaks-beres"));
                            ...
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><center><i>sudah approve, klik untuk lihat detail</i><br><input class="ui tiny green button" type="submit" value="<%=kode%>" name="kwh0-beres"></center></td> 
                                        <% } else if ((status != null) && (approve == null)) {%>
                                <td><center><i>sudah monitoring, klik untuk approve</i><br><input class="ui tiny blue button" type="submit" value="<%=kode%>" name="kwh0-approve"></center></td> 
                                    <% } else if (status == null) {%>
                                <td><center><i>belum monitor, klik untuk copy status terakhir</i><br><input class="ui tiny red button" type="submit" value="<%=kode%>" name="kwh0-belum"></center></td> 
                                    <% }
                                    } else if (tot_kwh > kwh_maks) {
                                        if ((status != null) && (approve != null)) {%>
                                <td><center><i>sudah approve, klik untuk lihat detail</i><br><input class="ui tiny green button" type="submit" value="<%=kode%>" name="kwhmaks-beres"></center></td> 
                                    <% } else if ((status != null) && (approve == null)) {%>
                                <td><center><i>sudah monitor, klik untuk approve</i><br><input class="ui tiny blue button" type="submit" value="<%=kode%>" name="kwhmaks-approve"></center></td> 
                                    <% } else if (status == null) {%>
                                <td><center><i>belum monitor, klik untuk copy status terakhir</i><br><input class="ui tiny red button" type="submit" value="<%=kode%>" name="kwhmaks-belum"></center></td> 
                                    <% }
                                        }
                                    %>  
                                </tr>
