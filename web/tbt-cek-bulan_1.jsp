...
<html>
    <%
        ...
        int count_sudah = LihatData_TBT.hitungtbt_sudahcek(bulantahun);
        int count_belum = LihatData_TBT.hitungtbt_belumcek(bulantahun);
        String status = null;
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT(bulantahun);

        if (request.getParameter("commit") != null) {
            String link = "tbt-cek-bulan_1.jsp";
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("tbt-cek-bulan_1.jsp");
        }
    %>
    <head>
            ...
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        ...
                        <b><%=count_sudah%></b> sudah dimonitoring.
                    </p>
                </div>
            </div>
        </div>
