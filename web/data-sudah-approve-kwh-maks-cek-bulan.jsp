...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekApprove_blth_kwhMaks(pBlth);
        int count = Approve.hitungApprove_sudahcek_maks(pBlth);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-sudah-approve-kwh-maks-cek-bulan.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
             session.setAttribute("link", "data-sudah-approve-kwh-maks-cek-bulan.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan dengan pemakaian listrik melebihi kwh maks yang sudah di-Approve.<br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 SUDAH APPROVE
                            </h4>
