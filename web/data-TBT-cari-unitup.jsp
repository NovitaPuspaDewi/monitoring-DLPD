...
<html>
    <%
        ...
        String status = null;
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_Unitup(unitup1);
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan UNITUP  <%=unitup1%>  dengan yang tidak beli token lebih dari 3 bulan.<br><br>
