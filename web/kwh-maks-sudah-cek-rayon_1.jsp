...
<html>
    <%
        ...
        List<LihatData_Rayon> kendaraanList = LihatData_Rayon.getDataList_ByUsername_belumcek_kwhmaks(idpel, blth);
        ...
        if (request.getParameter("foto") != null) {
            ...
            session.setAttribute("link1", "kwh-maks-sudah-cek-rayon_1.jsp");
        }
        ...
        if (request.getParameter("commit") != null) {
            ...
            out.print("window.location = 'kwh-maks-sudah-cek-rayon_1.jsp';");
            out.print("</script>");
