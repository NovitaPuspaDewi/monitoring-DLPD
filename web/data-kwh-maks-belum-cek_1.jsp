...
<html>
    <%
        int count = LihatData.hitungKwhmaks_belumcek();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
             session.setAttribute("link", "data-kwh-maks-belum-cek_1.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh maks yang belum dimonitoring<br><br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS BELUM CEK
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<LihatData> kendaraanList = LihatData.getDataList_kwhmaks_belum_cek();
