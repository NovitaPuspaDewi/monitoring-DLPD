...
<html>
    <%
        ...
        int count_belum = LihatData.hitungKwh0_belumcek(bulantahun);
        int count_sudah = LihatData.hitungKwh0_sudahcek(bulantahun);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-kwh-0-cek-bulan_1.jsp");
        }
        ...
        if(request.getParameter("commit1")!=null){
            session.setAttribute("id_blth", request.getParameter("commit1"));
             session.setAttribute("link", "data-kwh-0-cek-bulan_1.jsp");
            response.sendRedirect("kwh0-sudah-cek_1.jsp");
        }
    %>
