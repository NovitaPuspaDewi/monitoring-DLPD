...
<html>
    <%
        ...
        if (request.getParameter("commit") != null) {
            ...
            app.setmIdpel(idpel);
            app.setmBlth(blth);
            Approve_Rayon.Approve_Biasa_tbt(app);

            session.setAttribute("blth", blth);

            out.print("<script type=\"text/javascript\">");
            out.print("alert(\"Data monitoring telah di-approve\");");
            out.print("window.location = 'data-belum-approve-tbt-blth-rayon.jsp';");
            out.print("</script>");
        }

        if (request.getParameter("foto") != null) {
            session.setAttribute("link1", "tbt-detail-approve-blth-rayon.jsp");
                        ...
                        <div class="two fields">
                            ...
                            <div class="field">
                                <label>Klik untuk lihat Foto
                                    <input class="ui tiny red button" type="submit" value="LIHAT FOTO" name="foto">
                                    </div>
                                    </div>
