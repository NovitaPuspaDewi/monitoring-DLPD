...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_sudah_approve_unitup(kode);
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-sudah-approve-tbt-rayon.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan TBT UNITUP ${username} yang sudah di-Approve.<br>
                        <br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT SUDAH APPROVE UNITUP ${username}
                            </h4>
