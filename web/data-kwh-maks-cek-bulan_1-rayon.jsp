...
<html>
    <%
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-kwh-maks-cek-bulan_1-rayon.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh-maks-cek-bulan_1-rayon.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan UNITUP ${username} dengan pemakaian listrik melebihi kwh maks.<br>
