...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekSemua_Kwhmaks_belumApprove(blth_sess);
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-maks-detail-approve-blth.jsp");
        }
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-belum-approve-kwh-maks-blth.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh maks yang sudah dimonitoring, belum di-Approve
                    </p>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
