...
<html>
    ...
    String kode=session.getAttribute("username").toString();
        int count = LihatData_Rayon.hitungKwh0_belumcek(kode);
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh0-belum-cek-rayon_1.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh 0 UNITUP ${username} yang belum dimonitoring
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 UNITUP ${username} BELUM CEK
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<LihatData_Rayon> kendaraanList = LihatData_Rayon.getDataList_kwh0_belum_cek(kode);
