...
<html>
    <%
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_sudah_cek();
        int count = kendaraanList.size();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-tbt-sudah-cek.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan TBT yang sudah dimonitoring<br><br>
