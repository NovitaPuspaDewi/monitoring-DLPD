...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekSemua_KwhMaks_SudahApprove();
        int count = Approve.hitungApprove_sudahcek_maks();
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-sudah-approve-kwh-maks.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan dengan pemakaian listrik diatas kwh maks yang sudah di-Approve.<br>
                        <br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS SUDAH APPROVE
                            </h4>
