...
<html>
    <%
        int count_belum = Approve.hitungKwhMaks_yangsama();
        String status = null;

        if (request.getParameter("commit") != null) {

            String id = request.getParameter("commit");
            String link="tampil-data-yang-sama-kwh-maks.jsp";
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS YANG SAMA
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<Approve> kendaraanList = Approve.getDataListCekData_Yang_Sama_KwhMaks();
