...
<html>
    <%        
        int count = Approve.hitungApprove_belumcek_sudahmonitor_0();
        String status = null;
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-0-detail-approve.jsp");
        }
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 BELUM APPROVE
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%                                        
                                        List<Approve> kendaraanList = Approve.getDataListCekSemua_Kwh0_belumApprove();
