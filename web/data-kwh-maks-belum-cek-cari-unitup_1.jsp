...
<html>
    <%
        ...
        List<LihatData> kendaraanList = LihatData.getDataList_kwhmaks_belum_cek(unitup1);
        int count = kendaraanList.size();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh-maks-belum-cek-cari-unitup_1.jsp");
        ...
        if (request.getParameter("cari2") != null) {
            ...
            response.sendRedirect("data-kwh-maks-belum-cek-cari-unitup_1.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh maks yang belum dimonitoring UNITUP ${unitup}<br><br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS BELUM CEK UNITUP ${unitup}
                            </h4>
