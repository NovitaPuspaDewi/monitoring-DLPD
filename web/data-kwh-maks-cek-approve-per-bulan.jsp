...
<html>
    <%
        ...
        int count_belum = LihatData.hitungKwhmaks_belumAprove(bulantahun);
        int count_sudah = LihatData.hitungKwhmaks_sudahApprove(bulantahun);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-kwh-maks-cek-approve-per-bulan.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            response.sendRedirect("approve-kwh-maks.jsp");
        }

        if (request.getParameter("commit1") != null) {
            session.setAttribute("id_blth", request.getParameter("commit1"));
             session.setAttribute("link", "data-kwh-maks-cek-approve-per-bulan.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan dengan pemakaian listrik melebihi kwh maks sesuai daya kontrak.<br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS BULAN <%=bulantahun.substring(4)%> TAHUN <%=bulantahun.substring(0, 4)%>
                            </h4>
