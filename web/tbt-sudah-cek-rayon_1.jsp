...
<html>
    <%
        ...
        if (request.getParameter("commit") != null) {
            ...
            out.print("window.location = 'tbt-sudah-cek-rayon_1.jsp';");
            out.print("</script>");

        }

        if (request.getParameter("foto") != null) {
            session.setAttribute("link1", "tbt-sudah-cek-rayon_1.jsp");
                    ...
                    <div class="ui fluid form segment">
                        ...
                        <div class="two fields">
                            <div class="field">
                                ...
                                <input class="ui tiny red button" type="submit" value="FOTO" name="foto">
                            </div>
                            <div class="field">
                        ...
                        <div class="field">
                            <center><input class="ui tiny blue button" type="submit" value="UBAH DATA" name="commit"></center>
                        </div>
                    </div>
                </form>
                <div class="ui fluid form segment">
