...
<html>
    <%
        ...
        if (request.getParameter("commit") != null) {
            ...
            out.print("window.location = 'data-kwh-0-cek-approve-per-bulan-rayon.jsp';");
            out.print("</script>");
        }

        if (request.getParameter("foto") != null) {
            session.setAttribute("link1", "approve-kwh-0-rayon.jsp");
                        ...
                        <div class="two fields">
                            <div class="field">
                                <label>Klik untuk lihat Foto
                                    <center><input class="ui tiny red button" type="submit" value="LIHAT FOTO" name="foto"></center>
                            </div>
                            <div class="field">
