...
<html>
    <%
        int count = Approve.hitungApprove_belumcek_sudahmonitor_maks();
        String status = null;
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-maks-detail-approve.jsp");
        }
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS BELUM APPROVE
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<Approve> kendaraanList = Approve.getDataListCekSemua_KwhMaks_belumApprove();
