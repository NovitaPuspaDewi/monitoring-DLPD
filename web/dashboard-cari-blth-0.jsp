...
<html>
    <%
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("dashboard-cari-blth-0.jsp");
        }
                ...
                <div class="row">
                    <div class="ten wide column">
                        <h4 class="ui top attached center aligned inverted red block header">
                            <center>REKAP KWH 0<br>BULAN <%=month%> TAHUN <%=year%></center>
                        </h4>
                        <table class="ui padded table segment attached" id="filmTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%=i + 1%></td>
                                    <td><%=unitup%></td>
                                    <% jumlah = Dashboard.hitung_kwh0(bulan_tahun_terakhir, unitup);%>
                                    <td><%=jumlah%></td>
                                    <% sudahcek = Dashboard.hitungKwh0_sudahcek(bulan_tahun_terakhir, unitup);%>
                                    <td><%=sudahcek%></td>
                                    <% belumcek = Dashboard.hitungKwh0_belumcek(bulan_tahun_terakhir, unitup);%>
                                    <td><%=belumcek%></td>
                                    <% sudahapp = Dashboard.hitungKwh0_sudahapprove(bulan_tahun_terakhir, unitup);%>
                                    <td><%=sudahapp%></td>
                                    <% belumapp = Dashboard.hitungKwh0_belumapprove(bulan_tahun_terakhir, unitup);%>
                                    <td><%=belumapp%></td>
                                </tr>
                                <% }%>
                            </tbody>
