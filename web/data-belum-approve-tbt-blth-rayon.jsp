...
<html>
    <%
        String blth_sess = session.getAttribute("blth").toString();
        String month = blth_sess.substring(4);
        String year = blth_sess.substring(0, 4);
        String kode = session.getAttribute("username").toString();

        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_belum_approve(blth_sess, kode);
        ...
        String status = null;
         ...
         if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("tbt-detail-approve-blth-rayon.jsp");
        }
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-belum-approve-tbt-blth-rayon.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan TBT UNITUP ${username} yang sudah dimonitoring, belum di-Approve
                    </p>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT UNITUP ${username} BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
