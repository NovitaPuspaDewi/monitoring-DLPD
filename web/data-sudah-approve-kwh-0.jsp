...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekSemua_Kwh0_SudahApprove();
        int count = Approve.hitungApprove_sudahcek_0();
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-sudah-approve-kwh-0.jsp");
