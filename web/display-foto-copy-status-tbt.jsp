...
<html>
    <%
        ...
        String id1 = session.getAttribute("id_blth1").toString();
        String id2 = session.getAttribute("id_blth1").toString();

        String blth = id1.substring(0, 6);
        String idpel = id2.substring(6);
        String foto = null;

        List<Display_Foto> kendaraanList = Display_Foto.getFoto_Tbt(blth, idpel);
