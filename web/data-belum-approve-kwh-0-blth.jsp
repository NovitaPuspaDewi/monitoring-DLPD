...
<html>
    <%
        ...
        List<Approve> kendaraanList = Approve.getDataListCekSemua_Kwh0_belumApprove(blth_sess);
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-0-detail-approve-blth.jsp");
        }
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-belum-approve-kwh-0-blth.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh 0 yang sudah dimonitoring, belum di-Approve
                    </p>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
