...
<html>
    <%
        ...
        int count_belum = LihatData_Rayon.hitungKwh0_belumcek(bulantahun, kode);
        int count_sudah = LihatData_Rayon.hitungKwh0_sudahcek(bulantahun, kode);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-kwh-0-cek-bulan_1-rayon.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh-0-cek-bulan_1-rayon.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan UNITUP ${username} dengan pemakaian listrik 0 kwh.<br>
