...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_belum_approve_rayon(kode);
        ...
        String status = null;
         ...
         if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("tbt-detail-approve-rayon.jsp");
        }
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT UNITUP ${username} BELUM APPROVE
                            </h4>
