...
<html>
    <%
        ...
        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekSemua_Kwh0_belumApprove(blth_sess, kode);
        ...
        if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-0-detail-approve-blth-rayon.jsp");
        }
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-belum-approve-kwh-0-blth-rayon.jsp");
        }
    %>
    <head>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 UNITUP ${username} BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
