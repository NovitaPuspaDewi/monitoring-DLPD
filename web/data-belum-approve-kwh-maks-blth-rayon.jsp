...
<html>
    <%
        ...
        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekSemua_KwhMaks_belumApprove(blth_sess, kode);
       ...
       if (request.getParameter("commit") != null) {
            ...
            response.sendRedirect("kwh-maks-detail-approve-blth-rayon.jsp");
        }
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS UNITUP ${username} BELUM APPROVE <br> BULAN <%=month%> TAHUN <%=year%>
                            </h4>
