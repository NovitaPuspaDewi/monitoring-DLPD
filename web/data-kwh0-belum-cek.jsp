...
<html>
    <%
        int count = LihatData.hitungKwh0_belumcek();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-kwh0-belum-cek.jsp");
        ...
        if (request.getParameter("cari2") != null) {
            ...
            response.sendRedirect("data-kwh0-belum-cek-cari-unitup.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan kwh 0 yang belum dimonitoring<br><br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 BELUM CEK
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<LihatData> kendaraanList = LihatData.getDataList_kwh0_belum_cek();
