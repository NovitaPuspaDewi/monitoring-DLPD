...
<html>
    ...
    int count_belum = Approve_Rayon.hitungKwh0_yangsama(kode);
        String status = null;
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count_belum%></b> data pelanggan kwh 0 yang belum di-Approve,silakan klik tombol di kolom
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH 0 UNITUP ${username} YANG SAMA
                            </h4>
                            <table class="ui padded table segment attached" id="filmTable">
                                ...
                                <tbody>
                                    <%
                                        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekData_Yang_Sama_Kwh0(kode);
