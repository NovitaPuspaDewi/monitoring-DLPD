...
<html>
    <%
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-tbt-belum-cek-rayon_1.jsp");
            response.sendRedirect("tbt-belum-cek-rayon_1.jsp");
        }

        if (request.getParameter("lebih6") != null) {
            response.sendRedirect("tbt-belum-cek-lebih6-rayon_1.jsp");
        }

        if (request.getParameter("kurang6") != null) {
            response.sendRedirect("tbt-belum-cek-kurang6-rayon_1.jsp");
        }
    %>
    <head>
