...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_sudah_approve(pBlth);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-sudah-approve-tbt-blth.jsp");
        }

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "data-sudah-approve-tbt-blth.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan TBT yang sudah di-Approve bulan <%=bln%> tahun <%=thn%>.<br>
                        <br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT SUDAH APPROVE <br>
                                BULAN <%=bln%> TAHUN <%=thn%>
                            </h4>
