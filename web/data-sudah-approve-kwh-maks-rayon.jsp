...
<html>
    <%
        ...
        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekSemua_KwhMaks_SudahApprove(kode);
        int count = Approve_Rayon.hitungApprove_sudahcek_maks(kode);
    ...
    <head>
        ...
        <title>Data Kwh Maks Sudah Approve</title>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan UNITUP ${username} dengan pemakaian listrik diatas kwh maks yang sudah di-Approve.<br>
                        <br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN KWH MAKS SUDAH APPROVE UNITUP ${username}
                            </h4>
