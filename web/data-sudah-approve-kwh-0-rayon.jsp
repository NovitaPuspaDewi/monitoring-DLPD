...
<html>
    <%
        ...
        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekSemua_Kwh0_SudahApprove(kode);
        int count = Approve_Rayon.hitungApprove_sudahcek_0(kode);
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-sudah-approve-kwh-0-rayon.jsp");
    ...
    <head>
        ...
        <title>Data Kwh 0 Sudah Approve</title>
