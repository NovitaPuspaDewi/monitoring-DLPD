...
<html>
    <%
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_kurang6_sudah_cek();
        int count = kendaraanList.size();
        String status = null;

        if (request.getParameter("commit") != null) {
            session.setAttribute("id_blth", request.getParameter("commit"));
            session.setAttribute("link", "tbt-sudah-cek-kurang6.jsp");
            response.sendRedirect("tbt-sudah-cek.jsp");
        }

        if (request.getParameter("lebih6") != null) {
            response.sendRedirect("tbt-sudah-cek-lebih6.jsp");
        }

        if (request.getParameter("kurang6") != null) {
            response.sendRedirect("tbt-sudah-cek-kurang6.jsp");
        }

        if (request.getParameter("cari2") != null) {
            String unitup = request.getParameter("unitup");
            session.setAttribute("unitup", unitup);
            response.sendRedirect("data-tbt-sudah-cek-cari-unitup.jsp");
        }
    %>
    <head>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        <b><%=count%></b> data pelanggan TBT kurang dari 6 bulan yang sudah dimonitoring<br><br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT < 6 bulan SUDAH CEK
                            </h4>
