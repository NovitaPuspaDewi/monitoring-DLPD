...
<html>
    <%
        ...
        List<LihatData_TBT> kendaraanList = LihatData_TBT.getDataListTBT_sudah_approve();
        ...
        if (request.getParameter("commit") != null) {
            ...
            session.setAttribute("link", "data-sudah-approve-tbt.jsp");
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan TBT yang sudah di-Approve.<br>
                        <br>
                    ...
                    <div class="row">
                        <div class="ten wide column">
                            <h4 class="ui top attached center aligned inverted red block header">
                                DATA PELANGGAN TBT SUDAH APPROVE
                            </h4>
