...
public final class data_002dkwh_002dmaks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    ");
        ...
        String status = null;
        List<LihatData> kendaraanList = LihatData.getDataListKwhMaks_Semua();
        
        if(request.getParameter("commit")!=null){
            session.setAttribute("idpel",request.getParameter("commit"));
            response.sendRedirect("lihat-data-detail-pelanggan-kwh0.jsp");
        }
      ...
      out.write("        <title>Data Pelanggan Kwh Maks</title>\n");
      ...
      out.write("                            DATA PELANGGAN KWH MAKS\n");
      out.write("                        </h4>\n");
