...
<html>
    <%
        ...
        int count = LihatData_Rayon.hitungKwhMaks_semua(kode);
        String status = null;
        List<LihatData_Rayon> kendaraanList = LihatData_Rayon.getDataListKwhMaks_Semua(kode);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-kwh-maks-cari-blth-rayon.jsp");
        }
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> data pelanggan UNITUP ${username} dengan pemakaian listrik melebihi kwh maks sesuai kontrak.<br><br>
