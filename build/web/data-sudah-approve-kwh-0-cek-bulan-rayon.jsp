...
<html>
    <%
        ...
        List<Approve_Rayon> kendaraanList = Approve_Rayon.getDataListCekApprove_blth_kwh0(pBlth,kode);
        int count = Approve_Rayon.hitungApprove_sudahcek_0(pBlth, kode);
        ...
        if (request.getParameter("cari") != null) {
            ...
            response.sendRedirect("data-sudah-approve-kwh-0-cek-bulan-rayon.jsp");
        }
    ...
    <head>
        ...
        <title>Data Kwh 0 Sudah Approve Bulan ${blth}</title>
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> pelanggan UNITUP ${username} dengan pemakaian listrik 0 kwh yang sudah di-Approve.<br>
