...
<html>
    ...
    <body>
        <div class="ui fixed top menu">
            <div class="container">
                <a class="item" id="tambah-user" href="user-login.jsp">
                    <i class="user icon"></i>TAMBAH USER
                </a>
                <div class="ui pointing dropdown link item">
                    <i class="search icon"></i> LIHAT DATA <i class="dropdown icon"></i>
                    <div class="menu">
                        <a class="item" id="kwh0" href="data-kwh-0.jsp"><i class="archive icon"></i>Pelanggan Kwh 0</a>
                        <a class="item" id="kwhmaks" href="data-kwh-maks.jsp"><i class="archive icon"></i>Pelanggan Kwh Maks</a>
                        <a class="item" id="tidak-beli-token" href="data-TBT.jsp"><i class="archive icon"></i>Tidak Beli Token > 3 bulan</a>
                    </div>
                </div>
                ...
                <a class="item" id="cari-pelanggan" href="cari-pelanggan.jsp">
