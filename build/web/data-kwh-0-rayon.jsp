...
<html>
    <%
        ...
        int count = LihatData_Rayon.hitungKwh0_semua(kode_rayon);
        String status = null;
        List<LihatData_Rayon> kendaraanList = LihatData_Rayon.getDataListKwh0_Semua(kode_rayon);
        ...
        <div class="ui one column page grid">
            <div class="column">
                <div class="ui info message">
                    ...
                    <p>
                        Terdapat <b><%=count%></b> data pelanggan UNITUP ${username} dengan pemakaian listrik 0 kwh.<br><br>
